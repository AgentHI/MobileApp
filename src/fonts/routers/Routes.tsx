interface RoutesInterface {
  ...
  EditEmail: any;
  EditProfileWithoutToken: any;
  EditUnavailability: any;
  AskAnything: any;
  AskAnythingDetail: any;
}
